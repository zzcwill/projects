  ...
  function getCloudMirrorReport() {
    ...
    function getNewReport() {
        ...
        function reportV1CollectApi() {
          yjAjax({
            ...
            success: function (res) {
              ...
              showEndResults(res.detail.typeConclusion1, res.detail.typeConclusion2, res.detail.result);
              showRiskResults(res.detail.risks);
            }
          });
        }
        //综合结论接口调用
      ...
      function getAllPersonInfo() {
        ...
        //获取贷款人以及相关人report列表
        function getPersonReportList(arr) {
        ...
        function reportV1PersonsApi() {
          yjAjax({
            ...
            success: function (res) {
              ...
              getReportDemoHtml();
              //保存相关贷款人信息
              reportArrInfo = res.members;
              //生成右边固定导航条
              getMenuList(res.members);
              //生成贷款人以及相关人report列表
              getPersonReportList(res.members);
            }
          });
        }
        //获取贷款人以及相关人列表接口调用
