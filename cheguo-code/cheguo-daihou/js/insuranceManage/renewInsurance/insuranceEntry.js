...
if(type === "add") {
	...
	comn.ajax({
		...
		success: function (res) {
			...
			var len = res.data.loanInsuranceRenewalDetailList.length;
			for (var i = 0; i < len ; i += 1) {
                    ...
                    htmlTemp += "<tr>" + 
			                    	...
			                    	"<td class='id hidden'>" + item.insuranceTypeId + "</td>" +
			                   		...
			                   		"</td>" +
			                   		"<td>" +
			                   			"<input type='text' class='insuranceFee required' name='loanInsuranceRenewalDetailList[" + i + "].insuranceFee' value='" + insuranceFee + "'/>" +
			                   		"</td>" +
			                   		"<td>" +
			                   			"<input type='text' class='insuranceMoney required' name='loanInsuranceRenewalDetailList[" + i + "].insuranceMoney' value='" + insuranceMoney + "'/>" +
			                   		"</td>" +
        ...
        comn.ajax({
            ...
            success: function (res) {
                ...
                for (var i = 0; i < res.data.length; i += 1) {
                    ...
                    htmlTemp += "<tr>" + 
                    				"<td data-name='index'><span>" + (i + 1) +
			                    		"</span><input type='hidden' class='insuranceTypeId' name='loanInsuranceRenewalDetailList[" + i + "].insuranceTypeId'" +"' value='" + item.id + "'/>" +
			                    	"</td>" +
			                    	"<td class='id hidden'>" + item.id + "</td>" +
			                   		"<td>" + item.insuranceName +
			                   			"<input type='hidden' class='insuranceName' name='loanInsuranceRenewalDetailList[" + i + "].insuranceTypeName' value='" + item.insuranceName + "'/>" +
			                   		"</td>" +
			                   		"<td>" +
			                   			"<input type='text' class='insuranceFee required' name='loanInsuranceRenewalDetailList[" + i + "].insuranceFee' />" +
			                   		"</td>" +
			                   		"<td>" +
			                   			"<input type='text' class='insuranceMoney required' name='loanInsuranceRenewalDetailList[" + i + "].insuranceMoney' />" +
			                   		"</td>" +
                    ...
                    if (flagInsuranceInfoTable) {
                    	htmlTemp += "<tr>" + 
			                    	...
			                    	"<td class='id hidden'>" + item.id + "</td>" +
			                   		...
			                   		"</td>" +
			                   		"<td>" +
			                   			"<input type='text' class='insuranceFee required' name='loanInsuranceRenewalDetailList[" + len + "].insuranceFee' />" +
			                   		"</td>" +
			                   		"<td>" +
			                   			"<input type='text' class='insuranceMoney required' name='loanInsuranceRenewalDetailList[" + len + "].insuranceMoney' />" +
			                   		"</td>" +
			                   		"<td><a href='javascript:;' data-id='" + item.id + "'class='removeLoanInsuranceType'>删除</a></td>" +
		                   		"</tr>";
		                len += 1;
