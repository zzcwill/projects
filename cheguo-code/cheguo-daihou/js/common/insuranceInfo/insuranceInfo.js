var table_insurance, table_insuranceTel,handle_1, handle_2, tableEvent_1, tableEvent_2, table_settlementRecord;
//修改表格统一配置参数
var tableConfig = {};
...
$(".settlementRecord").click(function(){
  setTimeout(function(){
    $("#table_settlementRecord").bootstrapTable('resetView');
  }, 10)
})
table_settlementRecord = function(params) {
    tableData(params, {projectId: args["projectId"]}, interUrl.insurance.claimList)
};
$("#table_settlementRecord").bootstrapTable(tableConfig);
tableEvent_1 = {
