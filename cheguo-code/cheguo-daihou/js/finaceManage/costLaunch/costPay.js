...
comn.ajax({
  ...
  success: function (res) {
    ...
    $('#costForm input[name=paymentAmount]').val(res.data.approveAmount);
    $('#getFinace').click(function(){
      comn.addTab({
        title:"贷款详情",
        href: "./Modal/customManage/customer/loanDetail.html?loanApplyId="+ res.data.loanApplyId +"&projectId="+ res.data.projectId +"&space=LOAN&releventFlowNode=LOAN_QUERY&releventFlow=LOAN_QUERY"
      });
    });
  }
});
