...
withRelationship = function (value, row, index) {
    return [null, '主贷人', "", "担保人"][value] || '-';
};
...
$(function(){
    ...
    $(".tipLayer1").click(function(){
        $(".tipLayer1-alert").show();
    });
    ...
    common.Ajax({
        ...
        success: function(data) {
            ...
            if (data){
                ...
                for (i = 0; i < len; i++) {
                    o = data[i];
                    html += '<p>'+ (i+1) +'. ['+ withRelationship(o.loanScoreItem.withRelationship) +' - '+ o.loanCustomerName +'] '+ o.loanScoreItem.fileName +'</p>';
                }
                var _html = '<div class="am-ft-light am-ft-13" >'+html+'</div>'
                $("#am-list-detail").append(_html)
            }
        }
    })*/
    common.Ajax({
