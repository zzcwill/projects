    ...
    return vueComponent={
        ...
        selectComp:Vue.extend({
            props: {
                ...
                selected:{},
                labelClass: {default:'col-md-1 col-xs-1 col-sm-1'},
                selectClass: {default:'col-md-3 col-xs-3 col-sm-3'},
            ...
            '<select class="form-control" :class="class" :id="id" :name="name" :disabled="disabled" v-model="selected" :multiple="multiple">' +
        ...
        textArea: Vue.extend({
           ...
           template: '<div class="input-tip">' +
           '<label class="col-md-1 col-sm-1 col-xs-1 control-label">{{label}}:</label>' +
           '<div class="col-md-11">' +
        ...
        feeselectComp:Vue.extend({
            ...
            template:'<div class="input-tip">' +
            '<label class="col-md-1 control-label"><span class="text-danger" v-if="hasRequired()">*&nbsp;</span>{{label}}:</label>'+
            '<div class="col-md-3">' +
        ...
        radioComp:Vue.extend({
            template: '<div class="input-tip">' +
            '<label class="col-md-1 col-sm-1 col-xs-1 control-label"><span class="text-danger" v-if="hasRequired()">*&nbsp;</span>{{label}}</label>' +
        ...
        '<form :id="id" class="form-horizontal ibox-content">'+
            '<div class="panel panel-default">'+
                ...
                '<div class="panel-body">'+
                    ...
                    '<div class="form-group form-group-sm">'+
                        '<div class="input-tip">'+
                            '<label class="col-xs-1 col-sm-1 col-md-1 control-label">意见说明：</label>'+
