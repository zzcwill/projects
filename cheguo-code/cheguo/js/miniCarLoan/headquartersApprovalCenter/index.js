...
$(function () {
    //点击风险衍生数据-获取风险衍生数据内容
    $(".riskDerivativeData").on('click', function () {
        comn.ajax({
            url: interUrl.miniCarLoan.webankGetRiskDataPageUrl,
            data: {
                projectId: args["projectId"],
            },
            success: function (res) {
                var url = res.data.riskDataUrl;
                  ...
                  setTimeout(function () {
                    comn.ajax({
                      ...
                      success: function (res3) {
                        if (res3.data !== '0') {
                          $('#contentIframe2').css('height', res3.data + 'px');
                        }
                      }
                    });
                  }, 8000);
                } else {
                  $('#contentIframe2').css('height', res2.data + 'px');
                }
    ...
    $("input[name='conclusion']").on('click', function () {
        ...
        var btnClose = $('#btn-opinion-close');
