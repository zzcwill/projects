  ...
  <div class="container">
    <el-card class="box-card">
      <div class="container_hd">
        ...
        <el-input class="eCArdInput" v-model="cardInput" placeholder="请输入您要搜索的卡编号"></el-input>
        <el-button class="eCardBtn" @click="searchCardInfo" type="primary">搜索</el-button>
        ...
        <el-dialog :visible.sync="dialogFormVisible">
          <el-form :model="form" :rules="rules" ref="form">
            ...
            <el-form-item label="内存大小" :label-width="formLabelWidth" prop="size">
              <el-input style="width:50%" v-model="form.size" autocomplete="off"></el-input><span
                style="font-size:20px;margin-left:20px">kb</span>
            </el-form-item>
          </el-form>
    ...
    methods: {
      ...
      getCardManagement() {
        var params = {
          ...
          cardStatesCode: this.cardValue,
          cardNo: this.cardInput
        }
