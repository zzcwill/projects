<template>
  <div class="container">
    <el-card>
      ...
      <el-button type="primary" @click="searchInfoList(1)" icon="el-icon-search">搜索</el-button>
    </el-card>
    <el-card class="box-card">
      <el-table :data="tableData" border style="width: 100%">
        <el-table-column prop="warningCreateTime" label="刷卡时间" width="160">
        </el-table-column>
        <el-table-column prop="deviceCode" label="读卡器编号" width="160">
        </el-table-column>
        ...
        <el-table-column prop="playerId" label="用户名称" width="160">
        </el-table-column>
...
<script>
   import { InfoList } from '@/api/zkgl/skrzjl'
