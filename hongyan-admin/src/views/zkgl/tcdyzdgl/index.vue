  ...
  <div class="container">
    ...
    <el-card class="box-card">
      <el-table :data="tableData" border style="width: 100%">
        <el-table-column prop="terminalNo" label="编号" width="210">
        </el-table-column>
        ...
        <el-table-column prop="terminalName" label="名称" width="210">
        </el-table-column>
        <el-table-column prop="terminalModel" label="型号" width="210">
        </el-table-column>
        ...
        <el-table-column prop="" label="位置" width="210">
        ...
        <el-table-column prop="" label="操作">
          <tempalte slot-scope="scope">
            ...
            <el-button 
              v-if="scope.row.terminalStatesCode=='1'||scope.row.terminalStatesCode=='2'||scope.row.terminalStatesCode=='9'"
              type="text" @click="open(scope.row,1)">停用</el-button>
      ...
      <el-dialog @close="dialogClose('ruleForm')" title="设备新增" :visible.sync="dialogFormVisible">
        <el-form :model="form" :rules="rules" ref="ruleForm">
          ...
          <el-form-item :label-width="formLabelWidth" label="区域地址" prop="areaName">
            <yq-cascader ref="headerChild" style="width:100%" type="park" :query-data="{type:'area'}"
