<template>
  <div class="container">
    <el-card>
      ...
      <el-button type="primary" @click="searchInfoList">搜索</el-button>
    </el-card>
    <el-card class="box-card">
      <el-table :data="tableData" border style="width: 100%">
        ...
        <el-table-column prop="" label="操作">
          <tempalte slot-scope="scope">
            <el-button type="info" @click="open(scope.row,1)">停用</el-button>
            <el-button type="danger" @click="open(scope.row,2)">删除</el-button>
          </tempalte>
        </el-table-column>
      </el-table>
