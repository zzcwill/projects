    ...
    <div class="p-10 bg-white brs-4 def-shadow">
      ...
      <div>
        <el-table
          ...
          style="width: 100%"
        >
          <el-table-column prop="proposeContent" label="投诉内容" min-width="120">
          </el-table-column>
          <el-table-column prop="proposeName" label="投诉人" min-width="120">
          </el-table-column>
          <el-table-column prop="createTime" label="提交时间" min-width="120">
          </el-table-column>
          <el-table-column prop="replyContent" label="回复内容" min-width="120">
          </el-table-column>
