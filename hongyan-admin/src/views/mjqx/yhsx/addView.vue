  ...
  export default {
    ...
    methods: {
      ...
      save() {
            ...
            if (this.form.floor) {
              this.form.floor.forEach(item => {
                param.push({
                  ...
                  isGuest: employee.isGuest,
                  playerUserPhone: employee.playerUserPhone,
                  playerRealName: employee.playerRealName,
                  playerIdCard: employee.playerIdCard,
                  playerSex: employee.playerSex
                })
              })
            }
        ...
        editQx({ doorList: qxList, liftList: liftList }).then(res => {
          this.$message({
            message: '权限新增成功',
            type: 'success',
          })
