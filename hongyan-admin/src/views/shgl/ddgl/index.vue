        ...
        >
          ...
          <el-table-column label="操作" width="180" fixed="right">
            <div slot-scope="scope">
              <el-button type="text" size="mini" @click="refund('part',scope.row.id)">退款</el-button>
              <el-button type="text" size="mini" @click="refund('all',scope.row.id)">部分退款</el-button>
            </div>
          </el-table-column>
        </el-table>
      </div>
...
<script>
  import { listOrder, delOrder } from '@/api/shgl/ddgl'
