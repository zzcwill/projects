<template>
  <div class="container">
    <el-card class="box-card box-card-bd">
      ...
      <el-upload class="upload-demo" :headers="myHeaders" :action="baseUrl+'api/1.0/zkgl/parameter/uploadExcel'" :before-remove="beforeRemove" :limit="1" >
    ...
    <el-card class="box-card box-card-bd">
      <el-table :data="tableData" border style="width: 100%">
        ...
        <el-table-column prop="configKey" label="参数键定义" >
        </el-table-column>
        <el-table-column prop="configValue" label="参数值内容" >
        </el-table-column>
