<template>
  <div class="container">
    <el-card class="box-card box-card-bd">
      ...
      <el-upload class="upload-demo" :headers="myHeaders" :action="baseUrl+'/api/1.0/page/uploadExcel'"
      ...
      <el-upload class="upload-demo" :headers="myHeaders"
        :action="baseUrl+'/api/1.0/pageFunc/uploadExcel'" :before-remove="beforeRemove" :limit="1">
    ...
    <el-card class="box-card box-card-bd">
      <el-table :data="tableData" border style="width: 100%">
        <el-table-column prop="menuName" label="所属菜单名称" >
        </el-table-column>
        <el-table-column prop="fatherPageName" label="父页面名称" >
        </el-table-column>
        <el-table-column prop="pageName" label="页面名称" >
        </el-table-column>
        <el-table-column prop="pageVer" label="版本号" >
        </el-table-column>
        <el-table-column prop="" label="页面按钮" >
      ...
      <el-dialog title="页面名称" :visible.sync="dialogTableVisiblePageName">
      ...
      <el-dialog width='70%' title="画面名称" :visible.sync="dialogTableVisibleViewInfo">
