<template>
  <div class="container">
    <el-card class="box-card box-card-bd">
      ...
      <el-upload class="upload-demo" :headers="myHeaders" action="http://192.168.21.116:7777/api/1.0/classify/uploadExcel" :before-remove="beforeRemove" :limit="1" >
    ...
    <el-card class="box-card box-card-bd">
      <el-table :data="tableData" border style="width: 100%">
        <el-table-column prop="id" label="业务分类ID" width="360">
        </el-table-column>
        <el-table-column prop="classifyName" label="业务分类名称" width="360">
        </el-table-column>
        <el-table-column prop="classifySort" label="排序编号" width="360">
        </el-table-column>
