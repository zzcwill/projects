<template>
  <div class="container">
    <el-card class="box-card box-card-bd">
      ...
      <el-upload class="upload-demo" :headers="myHeaders" :action="baseUrl+'/api/1.0/dic/uploadExcel'"  :before-remove="beforeRemove" :limit="1" >
    ...
    <el-card class="box-card box-card-bd">
      <el-table :data="tableData" border style="width: 100%">
        <el-table-column prop="classifyId" label="业务分类ID">
        </el-table-column>
        <el-table-column prop="classifyName" label="业务分类名称">
        </el-table-column>
        <el-table-column prop="configSort" label="排序编号">
        </el-table-column>
        <el-table-column prop="typeCode" label="字典内容编码">
        </el-table-column>
        <el-table-column prop="typeName" label="字典内容名称">
        </el-table-column>
