    ...
    <div class="p-10 bg-white brs-4 def-shadow">
      ...
      <div>
        ...
        >
          ...
          <el-table-column prop="groupCode" label="策略组编号"></el-table-column>
...
<script>
  import { listDsGroup, delDsGroup } from '@/api/sbgl/clfz'
  ...
  export default {
    ...
    methods: {
      ...
      query() {
        listDsGroup(this.form).then(res => {
          this.list = res.data
