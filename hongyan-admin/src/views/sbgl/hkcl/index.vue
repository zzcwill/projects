    ...
    <div class="p-10 bg-white brs-4 def-shadow">
      ...
      <div>
        ...
        >
          ...
          <el-table-column prop="content" label="策略描述"></el-table-column>
...
<script>
  import { listDsAmbient, delDsAmbient } from '@/api/sbgl/hkcl'
  ...
  export default {
    ...
    methods: {
      ...
      query() {
        listDsAmbient(this.form).then(res => {
          this.list = res.data
