    ...
    <div class="p-10 bg-white brs-4 def-shadow">
      <div class="flex p-t-10 p-l-10 p-b-10">
        <div class="flex-center w-fit-content">
          <span class="w-130">厂商名称:</span>
          <el-input v-model="form.producerName" placeholder="请输入厂商名称"></el-input>
        </div>
      ...
      <div>
        <el-table
          ...
          tooltip-effect="dark"
        >
          <el-table-column prop="producerCode" label="厂商编号"></el-table-column>
          <el-table-column prop="producerName" label="厂商名称"></el-table-column>
          <el-table-column prop="contactName" label="厂商联系人"></el-table-column>
          <el-table-column prop="contactTelephone" label="厂商联系人电话"></el-table-column>
...
<script>
  import { listDeviceProducer, delDeviceProducer } from '@/api/sbgl/sccs'
  ...
  export default {
    ...
    methods: {
      ...
      query() {
        listDeviceProducer(this.form).then(res => {
      ...
      del(id) {
        delDeviceProducer({ id: id }).then(res => {
          this.query()
        }).catch(err => {
          this.$message.error(err)
        })
