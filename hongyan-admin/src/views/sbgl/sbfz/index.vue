    ...
    <div class="p-10 bg-white brs-4 def-shadow">
      ...
      <div>
        <el-table
          ...
          tooltip-effect="dark"
        >
          <el-table-column prop="groupCode" label="分组编号"></el-table-column>
          <el-table-column prop="groupName" label="分组名称"></el-table-column>
          <el-table-column prop="parentGroupName" label="上级分组"></el-table-column>
...
<script>
  import { listDeviceGroup, delDeviceGroup } from '@/api/sbgl/sbfz'
  ...
  export default {
    ...
    methods: {
      ...
      query() {
        listDeviceGroup(this.form).then(res => {
          this.list = res.data
