...
export function addPark(data) {
  return request({
    url: '/api/1.0/base/w301010park/append',
    method: 'post',
    data
  })
}
...
export function addBuilding(data) {
  return request({
    url: '/api/1.0/yqgl/park/appendBuilding',
    method: 'post',
    data
  })
}
...
export function editBuilding(data) {
  return request({
    url: '/api/1.0/yqgl/park/editBuilding',
    method: 'post',
    data
  })
}

export function infoBuilding(data) {
  return request({
    url: '/api/1.0/base/w301020building/info',
    method: 'post',
    data
  })
}
